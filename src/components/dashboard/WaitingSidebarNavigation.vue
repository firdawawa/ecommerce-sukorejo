            ...
            <div class="max-h-screen flex flex-wrap items-center align-middle justify-center mx-auto p-4">
                <div class="hidden h-full md:block md:h-auto" id="navbar-default">
                    ...
                    <div class="flex justify-center h-screen">
                        <button @click="logout" class="bg-secondary text-white px-4 py-2 rounded-md w-80 h-12 mt-96 text-center items-center content-center  hover:bg-red-600 transition duration-200">
                            Logout
                        </button>
                    </div>
                </div>
