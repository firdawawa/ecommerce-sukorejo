...
<div class="relative flex min-h-full z-50">
    ...
    <div class="hidden h-full md:block md:h-auto" id="navbar-default">
        ...
        <div class="logo text-6xl mt-6">
            <RouterLink to="/bumdes/overview" class="flex h-14 w-96 mx-auto justify-center items-center text-white rounded-3xl md:border-0 md:p-0">
                    LOGO
                </RouterLink>
        </div>
        ...
        <ul class="font-medium p-4 md:p-0 mt-4 border items-center border-gray-100 md:flex-row rtl:space-x-reverse md:mt-0 md:border-0 ">
            <li>
                <RouterLink to="/bumdes/overview" class="flex gap-4 h-14 w-96 mx-auto items-center align-middle text-white rounded-3xl hover:border-l-4 md:hover:bg-hover-primary md:border-0 md:p-0">
                    <img class="h-6 ml-8" src="../../assets/images/profile-icon.png" alt="icon-profile">
                    Overview
                </RouterLink>
            </li>
            <li>
                <RouterLink to="/bumdes/toko" class="flex gap-4 h-14 w-96 mx-auto mt-2 items-center align-middle text-white rounded-3xl hover:border-l-4 md:hover:bg-hover-primary md:border-0 md:p-0">
                    <img class="h-6 ml-8" src="../../assets/images/profile-icon.png" alt="icon-profile">
                    Toko
                </RouterLink>
            </li>
            <li>
                <RouterLink to="/bumdes/verifikasi" class="flex gap-4 h-14 w-96 mx-auto mt-2 items-center align-middle text-white rounded-3xl hover:border-l-4 md:hover:bg-hover-primary md:border-0 md:p-0">
                    <img class="h-6 ml-8" src="../../assets/images/profile-icon.png" alt="icon-profile">
                    Verifikasi Toko
                </RouterLink>
            </li>
