<template>
	<div class="relative flex min-h-full z-50">
		<!-- Sidebar Navigation -->
			...
			>
				<div class="hidden h-full md:block md:h-auto" id="navbar-default">
					...
					<div class="profile content-center mx-1 my-16">
						<RouterLink
							to="/dashboard/profil"
							class="flex content-center gap-6"
						>
							<img
							...
							<div class="content-center">
								<div
									id="user-name"
									class="text-white font-bold text-2xl content-center"
									>{{ user.name }}</div
								>
								<div class="flex content-center align-middle gap-3 mt-1">
									<div
										class="text-white text-lg font-light content-center tracking-wider"
										>{{ user.email }}</div
									>
								</div>
							</div>
					...
					>
						<li>
							<RouterLink
								to="/bumdes/overview"
								class="flex gap-4 h-14 w-96 mx-auto items-center align-middle text-white rounded-3xl hover:border-l-4 md:hover:bg-hover-primary md:border-0 md:p-0"
							>
								<img
									class="h-6 ml-8"
						...
						<li>
							<RouterLink
								to="/bumdes/toko"
								class="flex gap-4 h-14 w-96 mx-auto mt-2 items-center align-middle text-white rounded-3xl hover:border-l-4 md:hover:bg-hover-primary md:border-0 md:p-0"
							>
								<img
									class="h-6 ml-8"
									src="../../assets/images/profile-icon.png"
					...
					<div class="flex justify-center h-screen">
						<button
							@click="logout"
							class="bg-secondary text-white px-4 py-2 rounded-md w-80 h-12 mt-32 text-center items-center content-center hover:bg-red-600 transition duration-200"
						>
							Logout
						</button>
					</div>
