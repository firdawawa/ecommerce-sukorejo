            ...
            <div class="bg-white px-2 py-4 mx-5 -mt-2 mb-4 rounded-xl h-full">
                    ...
                    <div class="mr-8 mt-2">
                        <RouterLink :to="{ path: '/dashboard/produk/' + produk.id + '/edit' }">
                            <button class="flex gap-4 bg-secondary content-center justify-center align-middle h-12 py-2 px-10 rounded-xl">
                                ...
                                <span class="font-medium text-lg text-white content-center">Edit Data</span>
                            </button>
                        </RouterLink>
                    </div>
                </div>
                ...
                <div>
                    <div class="flex mt-6 justify-between">
                        <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-4 ml-8">
                            <div v-for="(file, index) in produk.files" :key="index" class="m-1">
                                <img :src="getImageUrl(file)" alt="Foto Produk" class="h-28 w-28 rounded-lg object-cover">
                            </div>
                        </div>
                        <div class="ml-auto text-right mr-8">
                            ...
                            <div class="mt-4">
                                <span id="createdat" class="text-font font-normal">Ditambahkan pada {{ formatDate(produk.created_at) }} </span>
                            </div>
                        </div>
                    </div>
                </div>
