    ...
    <div>
        ...
        <div class="flex-1 ml-1/4">
            <div class="bg-white px-12 py-4 mx-5 -mt-2 mb-4 rounded-xl h-full">
                ...
                <div class="flex justify-around">
                    <div class="columns-2 gap-12 mt-6">
                        ...
                        <div>
                            ...
                            <input type="text" v-model="model.produk.name" name="productname" id="productname" class="border border-gray-400 text-font rounded-lg focus:ring-primary-600 focus:border-primary-600 block h-12 w-full p-2.5 bg-white placeholder-gray-400" placeholder="ex: Jaket Rajut" required>
                        </div>
                        <div>
                            <label for="price" class="block mb-2 mt-6 justify-start text-left text-xl font-medium text-gray-900">Harga</label>
                            <input type="number" v-model="model.produk.price" name="price" id="price" class="border border-gray-400 text-font rounded-lg focus:ring-primary-600 focus:border-primary-600 block h-12 w-full p-2.5 bg-white placeholder-gray-400" placeholder="ex: 100000" required>
                        </div>
                        <br>
                        <br>
                        <br>
                        <div>
                            ...
                            <input type="text" v-model="model.produk.stock" name="stok" id="stok" class="border border-gray-400 text-font rounded-lg focus:ring-primary-600 focus:border-primary-600 block h-12 w-full p-2.5 bg-white placeholder-gray-400" placeholder="ex: ex 100" required>
                        </div>
                        <div>
                            <label 
                                for="file" 
                            ...
                            <span class="text-sm font-light text-gray-400">
                                *Format media yang dapat diunggah adalah .jpeg, .jpg, .png, atau .pdf dengan ukuran maksimal 100MB.
                            </span> 
                        </div>
                ...
                <div>
                    <form action="">
                            <div class="mr-4">
                                ...
                                <textarea type="text" v-model="model.produk.description" name="desc" id="desc" rows="6" class="border border-gray-400 text-font rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 bg-white placeholder-gray-400" placeholder="Tuliskan deskripsi produk" required></textarea>
                            </div>
                        </form>
                </div>
                ...
                <button type="submit" @click="saveProduk"  class="w-full text-white bg-primary hover:bg-primary-700 focus:ring-4 focus:outline-none focus:ring-primary-300 font-bold rounded-lg text-lg px-5 py-4 my-10 text-center">Simpan Data</button>
            </div>
        </div>
    </div>
</template>
...
export default {
    ...
    methods: {
        ...
        saveProduk() {
            ...
            axios.post(`http://127.0.0.1:8000/api/dashboard/store/${this.idStore}/product`, formData, {
                headers: {
