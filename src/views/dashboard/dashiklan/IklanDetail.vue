        ...
        <div class="flex-1 ml-1/4">
            <div class="bg-white px-2 py-4 mx-5 -mt-2 mb-4 rounded-xl h-full\">
                <div class="flex justify-between">
                    ...
                    <div class="flex">
                        <div class="mr-8 mt-2">
                            <button @click="navigateTo('/dashboard/iklan/edit')" class="flex gap-4 bg-primary content-center justify-center align-middle h-12 py-2 px-10 rounded-xl">
                                <span class="font-medium text-lg text-white content-center">Matikan Iklan</span>
                            </button>
                        </div>
                        <div class="mr-8 mt-2">
                ...
                <div>
                    <div class="flex mt-6 justify-between">
                        <div class="m-1 ml-8">
                            <img :src="getImageUrl(iklan.banner)" id="fotoiklan" alt="Foto Iklan" class="w-36 rounded-md mx-1 object-cover">
                        </div>
