				...
				<div class="mt-12 grid grid-cols-[17rem_1fr] divide-x-2">
					...
					<div class="pl-12 items-center">
						...
						<form
							...
							class="relative text-center items-center flex flex-col"
							action="#"
						>
							<div>
								<label
									for="oldpassword"
									class="block mb-2 mt-px justify-start text-left text-xl font-medium text-gray-900"
							...
							<p class="mt-3 w-[500px] text-left text-gray-600"
								>! Minimal terdiri dari 8 karakter</p
							>
							<button
								type="submit"
								@click="changePassword"
								:disabled="isLoading"
								class="w-[500px] text-white bg-primary hover:bg-primary-700 focus:ring-4 focus:outline-none focus:ring-primary-300 font-bold rounded-lg text-lg px-5 py-2.5 mt-10 text-center"
								>Simpan Data</button
							>
						</form>
					</div>
...
export default {
	...
	methods: {
		...
		changePassword() {
			...
			axios
				.put(
					`https://api.isnunas.my.id/api/update-password/${this.userId}`,
					formData,
					{
						headers: {
