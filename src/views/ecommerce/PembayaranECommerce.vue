				...
				<div class="flex items-center justify-center">
					<div class="w-full border border-primary rounded-xl px-6 py-10">
						...
						<div class="text-gray-500"
							>Lanjutkan ke proses pembayaran untuk menyelesaikan pesanan Anda.
							Pastikan nominal yang tertera di bawah ini sesuai dengan pesanan
							Anda!</div
						>
						<div class="text-font text-lg mt-8 font-semibold"
							>Jumlah yang perlu Anda bayar:</div
						>
						<div class="flex justify-center items-center mt-32">
							<div
								v-if="order && order.invoice"
								class="text-secondary text-4xl font-bold"
							>
						...
						<button
							type="submit"
							@click="payment"
							class="w-full text-white bg-primary hover:bg-secondary border focus:ring-4 focus:outline-none focus:ring-primary-300 font-bold rounded-lg text-xl px-5 py-5 mt-32 mb-4 text-center"
		...
		async payment() {
			try {
				...
				const response = await axios.post(
					'https://api.isnunas.my.id/api/test-midtrans',
					{
