		...
		<div class="flex-1 ml-1/4">
			<div class="bg-white px-12 py-4 mx-5 -mt-2 mb-2 rounded-xl h-full">
				<div class="flex justify-between">
					<div class="font-bold text-2xl my-4 text-font">
						...
						<tbody>
							...
							>
								<th scope="row" class="px-6 py-2 font-medium">
									<RouterLink
										:to="{ path: '/bumdes/verifikasi/' + store.id + '/detail' }"
									>
										{{ index + 1 }}
									</RouterLink>
								</th>
				...
				<div>
					<div
						id="noVerif"
						v-if="store.length === 0"
						class="text-2xl font-bold text-primary text-center align-middle my-72"
					>
