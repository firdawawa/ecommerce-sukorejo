		...
		<div class="flex-1 ml-1/4">
			<div class="bg-white px-12 py-4 mx-5 -mt-2 mb-2 rounded-xl h-full">
				<div class="flex justify-between">
					<div class="font-bold text-2xl mt-4 text-font"> Antrian Verifikasi Toko Baru</div>
                ...
                <!-- DATA -->
                        <div class="flex">
                            ...
                            <div class="text-font text-md font-normal pr-6 w-[800px]">
                                <h4 id="date-regist" class="py-2">{{ formatDate(store.created_at) }}</h4>
                            </div>
                        </div>
                        <div class="flex">
                            <div class="text-font w-60">
                        ...
                        <div class="flex">
                            ...
                            <div class="text-font text-md font-normal pr-6 w-[800px]">
                                <h4 id="phone" class="py-2">{{ user.phoneNumber || 'Nomor Telepon tidak tersedia' }}</h4>
                            </div>
                        </div>
                        <hr class="h-px my-6 mr-8 bg-gray-400 border-1">
                        <div class="flex">
                        ...
                        <div class="flex">
                            ...
                            <div class="text-font text-md font-normal pr-6 w-[800px]">
                                <h4 id="address" class="py-2">{{ user.addressDetail || 'Alamat tidak tersedia' }}, {{ district || 'District tidak ditemukan' }}</h4>
                            </div>
                        </div>
                <!-- ACTION BUTTON -->
                <div class="flex gap-6 mt-20 mb-12">
                    <button @click="deleteStore" class="flex gap-4 bg-red-500 content-center justify-center align-middle w-1/2 py-4 px-4 rounded-lg">
                        <span class="text-white font-medium text-lg">Tolak</span>
                    </button>
                    <button @click="verifStore" class="flex gap-4 bg-green-500 content-center justify-center align-middle w-1/2 py-4 px-4 rounded-lg">
